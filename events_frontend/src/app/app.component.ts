import { Component, HostListener, Renderer2, OnInit, Input, ChangeDetectorRef, AfterContentChecked } from '@angular/core';
...
export class AppComponent implements OnInit, AfterContentChecked {
	@Input() mostrar = true;
	public appSetings = appSettings
	constructor(private _localService: LocalService, private titleService: Title, private router: Router, private renderer: Renderer2, private cdref: ChangeDetectorRef) {
		let usaraqui = _localService.getJsonValue("usar-aqui")
		if (usaraqui == true) {
			this.mostrar = false
		}
